  ...
  return <div className="fixed inset-0 z-50 grid place-items-center bg-[rgba(23,23,23,.42)] p-5" role="dialog" aria-modal="true" aria-labelledby="native-print-title">
    <div className="w-full max-w-[650px] overflow-hidden rounded-xl bg-white shadow-[0_18px_40px_rgba(23,23,23,.22)]">
      <header className="flex min-h-[58px] items-center gap-3 border-b border-[var(--border-soft)] px-5">
        ...
        <div><h2 id="native-print-title" className="text-[17px] font-bold">Print using Windows</h2><p className="text-[11.5px] text-[var(--ink-3)]">Native A4 preview with direct access to the selected printer&apos;s settings</p></div>
      ...
      <div className="p-5">
        ...
        <p className="mt-3 text-[11.5px] leading-4 text-[var(--ink-3)]">The helper shows the print-ready A4 sheet. Choose a printer, check <b>Printer settings</b> for its paper and quality controls, then select Print.</p>
      </div>
